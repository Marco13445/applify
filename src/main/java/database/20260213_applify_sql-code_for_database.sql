...
-- updated on 20260213 with the following new columns `nextInterviewDate`,`nextInterviewLink`, `nextInterviewPlace`,`contactPersonFullName`,`notes`
-- importantly: schema-name changed from 'joblify' to 'applify'
