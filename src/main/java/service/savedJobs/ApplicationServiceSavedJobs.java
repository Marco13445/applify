...
public class ApplicationServiceSavedJobs extends ApplicationService {
    //Fields
    private List<JobApplication> savedJobsList;
    private final DatabaseHandlerSavedJobs databaseHandlerSavedJobs;

    //constructor with dependency injection
    public ApplicationServiceSavedJobs(DatabaseHandlerSavedJobs databaseHandlerSavedJobs) {
