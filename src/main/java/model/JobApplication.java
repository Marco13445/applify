...
public class JobApplication {
     ...
     */
    public JobApplication(int id, String postingName, String company, String postingLink, String contactPersonFullName, String notes) {
        this.id = id;
    ...
    //Constructor for new, larger table which had been introduced in 13.02.2026, which of 09.03.2026 is the constructor for 'applied Jobs'
